...
public enum ResponseCode {
    ...
    NULL_POINTER(2000, "null pointer exception"),
    UN_KNOWN(2001, "unknown exception"),
    WITHOUT_PARAMETER(2002, "without parameter"),
    REQUEST_METHOD_NOT_SUPPORTED(2003, "request method not supported");
